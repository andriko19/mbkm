    ...
    <footer class="footer">
      <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">&copy; Copyright <strong>2023</strong><a href="http://ict.uwp.ac.id/" style="color: #782f40;" target="_blank"> TIK UWP</a></span>
      </div>
    </footer>
    <!-- partial -->
    </div>
